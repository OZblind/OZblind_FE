  ...
  return (
    <button
      ...
      className={`w-full px-4 py-3 text-left transition-all duration-150 border-l-2 ${
        isSelected
          ? "bg-primary/10 border-l-primary shadow-md"
          : "border-l-transparent hover:bg-base-content/5 hover:border-l-base-content/20"
      }`}
      role="option"
    ...
    >
      <div className="flex items-start justify-between">
        <div className="flex-1 min-w-0">
          ...
          <div className="text-xs mb-2 line-clamp-1 text-base-content/70">
        ...
        <div className="flex-shrink-0 ml-3">
          <span className="bg-base-300 text-base-content px-2 py-1 rounded-full text-xs font-medium">
            {post.category}
          </span>
        </div>
      </div>
